...
// Calculate ratings for games since given date and update team stats accordingly
exports.get = function (req) {
    ...
    games.forEach(function (game) {
        try {
            foosRatingLib.calculateGameTeamRatings(game);
        } catch (error) {
            log.warning("Could not calculate game rankings for: " + game._path + ": " + error);
        }
    });
